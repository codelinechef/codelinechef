...
[![Spotify](https://spotify-readme.sp-xd.vercel.app/api/spotify)](https://open.spotify.com/user/31huhe76cnomr5ezk4tgsa4y44l4) <br>
...
class About extends Me { 
  const myTools = {  
    "ProgramingLanguages" : { "C++", "C(novice)", "Python(novice)" },
    "Other Technologies" : { "HTML", "CSS", "Bash", "Json", "Markdown" },
    "Database" : { "MySql" },
    "Editors" : { "Vscode", "Atom" }
  };
}
